...
(
    SAMPLE,
    IDS,
) = glob_wildcards("results/parse_diff_exp/{sample}.{id}.txt")
...
rule clinical_only:
    input:
        # clinical annotation
        expand(
            "results/clinical_annotation/{sample}.{clusterid}.clinicalAnnotation.txt",
            sample=sample_ids,
            clusterid=IDS,
        ),
        expand(
            "results/query_civic/{sample}.{clusterid}.clinicalAnnotation.civic.txt",
            sample=sample_ids,
            clusterid=IDS,
        ),
